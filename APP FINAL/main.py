...
class Game(Widget):
    ...
    def mostrar_menu(self):
        ...
        self.puntajeLabel.pos = (self.width / 2 - self.puntajeLabel.width/2, self.top-self.puntajeLabel.height*1.5)
        self.mejor_puntaje.pos = (self.width / 2 - self.mejor_puntaje.width/2, self.top-self.mejor_puntaje.height*2)
...
class GameApp(App):
    def build(self):
        ...
        game.mejor_puntaje = game.ids.mejorPuntaje_label
